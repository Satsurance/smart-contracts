...
describe("Insurance", async function () {
  async function basicFixture() {
    ...
    // Setup common BTC transfers and approvals
    const underwriterInitialBalance = ethers.parseUnits("21000000", "ether"); // Large enough for all tests
    const ownerApprovalAmount = ethers.parseUnits("2000", "ether");
    const underwriterApprovalAmount = ethers.parseUnits("51000000", "ether"); // Large enough for all tests
